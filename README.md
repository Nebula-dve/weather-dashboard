...
- 🌡️ **当前天气**：温度、体感、湿度、风速、风向（emoji 图标 + 描述）
- 📅 **未来 24 小时 + 7 天预报**：温度、天气、降水概率
- 📊 **24 小时降水量图表**（原生 Canvas，无依赖）
- 🌫️ **空气质量**：US AQI / PM2.5 / PM10（六级分级配色）
- ⭐ **多城市收藏**（localStorage 持久化，一键切换）
- 🌐 **中 / 英多语言切换**
- 🌓 **深 / 浅主题**（跟随系统 + 手动切换）
- 📱 **PWA**：可安装到桌面、静态资源离线缓存
- 📍 **浏览器定位** + 响应式 + 🛡️ **隐私友好**（不收集/不存储/不上传任何数据）
